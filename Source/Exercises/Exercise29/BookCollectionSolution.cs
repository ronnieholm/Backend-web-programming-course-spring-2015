...
namespace Exercises.Exercise29
{
    class RunnerSolution
    {
        public void Run()
        {
            ...
            BookCollectionSolution books = new BookCollectionSolution();
            books.AddBook(b1);
            books.AddBook(b2);
            books.AddBook(b3);
            books.AddBook(b4);
    ...
    class BookCollectionSolution
    {
        private List<Book> _books;

        public BookCollectionSolution()
        {
        ...
        public Book LookupBook(string isbn)
        {
            ...
            foreach (Book b in _books)
            {
                if (b.GetISBN() == isbn)
                {
                    // now match refers to book with matching ISBN
                    match = b; 
                }
            }
